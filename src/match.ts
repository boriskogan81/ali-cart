...
- Many listings sell several variants in one page (e.g. "1700KV 1900KV 2400KV", "with/without receiver", "1pc/4pcs"). Include those and put the variant the row needs into "variant" as a short label the buyer would pick on the page (e.g. "1900KV", "RHCP SMA", "4pcs", "6S 1300mAh"). Whenever the title lists more than one option, "variant" MUST be filled in; the page default is often the cheapest, wrong option.
